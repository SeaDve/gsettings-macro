...
impl Settings {
    ...
    pub fn window_width(&self, value: i32) -> Result<(), glib::BoolError> {
    ...
    pub fn window_height(&self, value: i32) -> Result<(), glib::BoolError> {
    ...
    pub fn is_maximized(&self, value: bool) -> Result<(), glib::BoolError> {
    ...
    pub fn history(&self, value: &str) -> Result<(), glib::BoolError> {
    ...
    pub fn preferred_audio_source(&self, value: &str) -> Result<(), glib::BoolError> {
